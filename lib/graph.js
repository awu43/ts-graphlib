...
// TODO: resolve prefer-destructuring and no-param-reassign
...
Graph.prototype.setDefaultNodeLabel = function (newDefault) {
  this._defaultNodeLabelFn = !_.isFunction(newDefault)
    ? _.constant(newDefault)
    : newDefault;
  return this;
};
...
Graph.prototype.children = function (v_) {
  const v = _.isUndefined(v_) ? GRAPH_NODE : v_;
...
Graph.prototype.setDefaultEdgeLabel = function (newDefault) {
  this._defaultEdgeLabelFn = !_.isFunction(newDefault)
    ? _.constant(newDefault)
    : newDefault;
  return this;
};
