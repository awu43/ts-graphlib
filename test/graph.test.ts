...
describe("Graph", () => {
  ...
  describe("predecessors", () => {
    ...
    it("returns the predecessors of a node", () => {
      ...
      g.setEdge("b", "c");
      g.setEdge("a", "a");
      expect(g.predecessors("a")).to.eql(["a"]);
      expect(g.predecessors("b")).to.eql(["a"]);
      expect(g.predecessors("c")).to.eql(["b"]);
    });
  });
  ...
  describe("successors", () => {
    ...
    it("returns the successors of a node", () => {
      ...
      expect(g.successors("b")).to.eql(["c"]);
      expect(g.successors("c")).to.eql([]);
    });
  });
  ...
  describe("inEdges", () => {
    ...
    it("works for multigraphs", () => {
      ...
      expect(g.inEdges("a")).to.eql([]);
      expect(g.inEdges("b"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "bar" },
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
    ...
    it("can return only edges from a specified node", () => {
      ...
      expect(g.inEdges("b", "a"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
    });
  ...
  describe("outEdges", () => {
    ...
    it("works for multigraphs", () => {
      ...
      g.setEdge("a", "b", undefined, "bar");
      g.setEdge("a", "b", undefined, "foo");
      expect(g.outEdges("a"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "bar" },
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
    ...
    it("can return only edges to a specified node", () => {
      ...
      g.setEdge("z", "a");
      g.setEdge("z", "b");
      expect(g.outEdges("a", "b"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
  ...
  describe("nodeEdges", () => {
    ...
    it("works for multigraphs", () => {
      ...
      g.setEdge({ v: "a", w: "b", name: "foo" });
      expect(g.nodeEdges("a"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "bar" },
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
      expect(g.nodeEdges("b"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "bar" },
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
    ...
    it("can return only edges between specific nodes", () => {
      ...
      g.setEdge("z", "a");
      g.setEdge("z", "b");
      expect(g.nodeEdges("a", "b"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
      expect(g.nodeEdges("b", "a"), "name").to.have.deep.members([
        { v: "a", w: "b", name: "foo" },
        { v: "a", w: "b" },
      ]);
    });
